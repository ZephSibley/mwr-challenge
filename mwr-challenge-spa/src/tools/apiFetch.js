...
function apiFetch (keywords, apiFunction) {
    return new Promise(function (resolve, reject) {
    debounce( //On a timer to prevent overcalling the API
        fetch("https://www.alphavantage.co/query?function=" + apiFunction + "&keywords=" + keywords + "&apikey=" + process.env.REACT_APP_API_KEY)
            .then(response => {
